...
gym.register(
    id="Isaac-Velocity-RMA-Flat-Anymal-D-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.flat_env_cfg:AnymalDFlatRMAEnvCfg",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_rma_ppo_cfg:AnymalDFlatRMAPPORunnerCfg",
        "rsl_rl_distillation_cfg_entry_point": (
            f"{agents.__name__}.rsl_rl_rma_distillation_cfg:AnymalDFlatRMADistillationRunnerCfg"
        ),
    },
)

gym.register(
    id="Isaac-Velocity-RMA-Rough-Anymal-D-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.rough_env_cfg:AnymalDRoughRMAEnvCfg",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_rma_ppo_cfg:AnymalDRoughRMAPPORunnerCfg",
        "rsl_rl_distillation_cfg_entry_point": (
            f"{agents.__name__}.rsl_rl_rma_distillation_cfg:AnymalDRoughRMADistillationRunnerCfg"
        ),
    },
)
