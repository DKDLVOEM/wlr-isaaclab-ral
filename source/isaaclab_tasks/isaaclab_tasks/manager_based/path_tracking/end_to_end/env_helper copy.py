...
def add_base_play_configuration(self):
    ...
    # NEW add
    self.commands.path_command.max_speed = 3.3


    # NEW add
    # self.commands.path_command.max_speed = 7.0
    # self.commands.path_command.max_speed = 5.0
    ...
    # NEW add drift
    # self.commands.path_command.path_config = {
    #     "spline_angle_range": (90.0, 90.0),
    #     "rotate_angle_range": (0.0, 0.0),
    #     "pos_tolerance_range": (0.2, 0.2),
    #     "terrain_level_range": (0.0, 0.0),
    #     "resolution": [5.0, 5.0, 0.1, 1],
    #     "initial_params": [90.0, 0.0, 0.2, 0],
    # }
